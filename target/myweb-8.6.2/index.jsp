...
<body>
	...
	<h1 style="color: red; font-size: 40px;" align="center">WE INTEGRATED JENKINS </h1>
	<h1 style="color: indigo; font-size: 40px;" align="center">WE INTEGRATED TOMCAT TO JENKINS</h1>
